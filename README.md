...
## Özellikler
- **Arama Modları**:
  - **Yazar**: ORCID veya Yazar ID ile arama. Opsiyonel kurum filtresi.
  - **Kurum**: Doğrudan Kurum ID (AF-ID) ile arama.
- **Filtreler**: Konu Alanı, Yıl Aralığı ve Doküman Tipi filtreleri.
...
- **Dışa Aktar**: Sonuçları **Excel (.xlsx)** veya **CSV** olarak indirme.
